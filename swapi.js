...
const server = http.createServer((req, res) => {
    if (req.url === "/" || req.url === "/index.html") {
        ...
        res.writeHead(paginaNaoEncontrada, { "Content-Type": "text/plain" });
        res.end("Not Found");
    }
});
const Acesso = 3000;
const PORT = process.env.PORT || Acesso;
server.listen(PORT, () => {
